...
embedding_model_path = "/home/linke/yoyo/mobile_disk/edgerag/models/Alibaba-NLP/gte-base-en-v1.5"
dataset_path = "/home/linke/yoyo/mobile_disk/edgerag/dataset/"
index_path_local = "/home/linke/yoyo/mobile_disk/edgerag/index/"
...
def runIndex(
    ...
    embeddedModelName = embedding_model_path,
    num_embeddings = 768,
    ...
    embed_model = HuggingFaceEmbedding(model_name=embeddedModelName, trust_remote_code=True, embed_batch_size = 32)
    ...
    for dataset in datasets:
        ...
        print("-------------------------------------")
        index_dir = os.path.join(index_path_local, "index", dataset + "_" + str(chunk_size_large)+"_"+index_type)
...
def runIndex_first_stage(
    ...
    for dataset in datasets:
        ...
        print("runIndex_first_stage index_dir: " + index_dir)
        if(os.path.exists(index_dir)):
            print("Index exists, skipping")
            continue
...
def create_second_stage(
    ...
    embed_model = HuggingFaceEmbedding(model_name=embeddedModelName, trust_remote_code=True, embed_batch_size = 256)
    Settings.embed_model = embed_model
    Settings.llm = None
    Settings.chunk_size = chunk_size_large
    Settings.chunk_overlap = chunk_overlap
    ...
    for dataset in datasets:
        ...
        index_dir = os.path.join(index_path_local, "index", dataset + "_two_level")
        index_dir = os.path.join(index_dir+"_"+str(cluster_size))
        print("create_second_stage index_dir: " + index_dir)
...
# runIndex_first_stage(datasets, chunk_size_large=256, kmeans_niter=15, cluster_size = 8)
# runIndex_first_stage(datasets, chunk_size_large=256, kmeans_niter=15, cluster_size = 16)
...
# runIndex_first_stage(datasets, chunk_size_large=1024, kmeans_niter=15, cluster_size = 32)
